...
scp wp/scripts/od-films.php od-root:public_html/
ssh od-root 'cd ~/public_html && wp --skip-plugins --skip-themes eval-file od-films.php'         # dry run
ssh od-root 'cd ~/public_html && wp --skip-plugins --skip-themes eval-file od-films.php apply'
