...
1. **`/materials/` index + `plakati` · `zakladki` · `metodichki`** (partial D8) — 62 % of the section's entries for ~30 % of the build. `articles` ✅ already done as an alias. The **index** has only 107 entries but 939 views (8.8×) — build it for the second reason.
