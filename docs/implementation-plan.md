...
2. ~~**Go-ahead to write to od-stage.**~~ — **granted, and used: od-stage was wiped and re-synced from live prod on 2026-08-20** (runbook §0.5). It is now a faithful prod clone at `https://stage.od.webtm.ru`, so A7 has the rehearsal target it needs and prod does not have to be it.
