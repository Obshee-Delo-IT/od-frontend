...
- **Root-relative `/wp-content/…` links 404 on this site.** Not the same shape as the bullet above and not fixed by it: these are already paths, and the file they name lives only on the WordPress host. Measured on od-dev 2026-08-17 — **12 724 across 5 052 published posts, 286 across 37 pages**. Open as **D6d** in [`implementation-plan.md`](./implementation-plan.md), to be fixed in the pipeline for the same reason: 13 000 links is not a content edit. **Don't chase them page by page.**
